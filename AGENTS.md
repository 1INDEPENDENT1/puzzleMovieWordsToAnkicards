...
## Active Technologies
- Java 21 + Spring Boot 3.2.x, Spring MVC, Thymeleaf, Spring Data JPA, PostgreSQL JDBC driver, Java HttpClient, Jsoup, org.drugov:lingua-core 0.1.0, JUnit 5, Mockito, Testcontainers PostgreSQL (003-merge-export-logic)
...
- Java 21 + Spring Boot 3.2.x, Spring MVC, Thymeleaf, Spring Data JPA, PostgreSQL JDBC driver, JUnit 5, Mockito, Testcontainers PostgreSQL; no new runtime dependencies for in-app review cards (004-custom-anki-review)
